...
export default function PlayerDetailsModal({
  ...
  useEffect(() => {
    ...
    setTeam(team);
    const position = generalHelpers.getPlayerPositionStringByPlayer(
      player,
      elementTypes
    );
  ...
  const jerseyImagePath =
    player && player.team_code
      ? `/assets/images/kits/${player.team_code}.png`
      : "/assets/images/kits/default.png";
