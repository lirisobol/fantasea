...
import { removePick } from '../../../store/slices/draft';
...
export default function PlayerDetailsModalDraft({ show, onHide, player }: PlayerDetailsModalProps) {
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className='p-4 flex flex-row gap-4'>
                        <button className='bg-gradient-to-r from-sky-400 to-emerald-500 hover:to-sky-400 transition px-4 py-2 rounded-md text-white w-full'>
                            Replace Player
                        </button>
                        <button 
                            className='bg-gradient-to-r from-red-400 to-pink-500 hover:from-red-500 hover:to-red-600 transition px-4 py-2 rounded-md text-white w-full'
