                      ...
                      <div>
                        ...
                        <p className="mt-1 flex text-xs text-gray-500">
                          <span className="truncate">
                            ...
                            <span className="font-semibold ml-2 text-gray-500">
                              {player.stats && player.stats?.transfers_in_event - player.stats?.transfers_out_event > 0 ? 
                              <span className="text-teal-500">
                                {player.stats?.transfers_in_event - player.stats?.transfers_out_event}
                              </span> : 
                              <span className="text-rose-500">
                                {player.stats && player.stats?.transfers_in_event - player.stats?.transfers_out_event}
                                </span>}
                            </span>
                          </span>
                        </p>
                        <p className="mt-1 flex text-xs text-gray-500">
                          <span className="truncate">
                            ...
                            <span className="font-bold ml-2">
                              ...
                              <FontAwesomeIcon icon={faGripfire} style={{color:"red", marginLeft:10, scale:"1.3"}}/>
                            }
                            </span>
                          </span>
                        </p>
